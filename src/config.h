...
#elif defined(_PSP2)
    #define CONFIG_FILE "ux0:/data/jy/config.lua"
    #define DEBUG_FILE "ux0:/data/jy/debug.txt"
    #define ERROR_FILE "ux0:/data/jy/error.txt"
    #define HZMB_FILE "ux0:/data/jy/hzmb.dat"
#else
